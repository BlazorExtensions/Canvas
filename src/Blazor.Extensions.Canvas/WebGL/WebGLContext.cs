...
namespace Blazor.Extensions.Canvas.WebGL
{
    public class WebGLContext : RenderingContext
    {
        ...
        public async Task ClearColorAsync(float red, float green, float blue, float alpha) => await this.CallMethodAsync(CLEAR_COLOR, red, green, blue, alpha);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void Clear(BufferBits mask) => this.CallMethod<object>(CLEAR, mask);
        public async Task ClearAsync(BufferBits mask) => await this.CallMethodAsync(CLEAR, mask);
        ...
        public async Task ScissorAsync(int x, int y, int width, int height) => await this.CallMethodAsync(SCISSOR, x, y, width, height);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void Viewport(int x, int y, int width, int height) => this.CallMethod<object>(VIEWPORT, x, y, width, height);
        public async Task ViewportAsync(int x, int y, int width, int height) => await this.CallMethodAsync(VIEWPORT, x, y, width, height);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void ActiveTexture(Texture texture) => this.CallMethod<object>(ACTIVE_TEXTURE, texture);
        public async Task ActiveTextureAsync(Texture texture) => await this.CallMethodAsync(ACTIVE_TEXTURE, texture);
        ...
        public async Task BlendColorAsync(float red, float green, float blue, float alpha) => await this.CallMethodAsync(BLEND_COLOR, red, green, blue, alpha);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void BlendEquation(BlendingEquation equation) => this.CallMethod<object>(BLEND_EQUATION, equation);
        public async Task BlendEquationAsync(BlendingEquation equation) => await this.CallMethodAsync(BLEND_EQUATION, equation);
        ...
        public async Task BlendEquationSeparateAsync(BlendingEquation modeRGB, BlendingEquation modeAlpha) => await this.CallMethodAsync(BLEND_EQUATION_SEPARATE, modeRGB, modeAlpha);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void BlendFunc(BlendingMode sfactor, BlendingMode dfactor) => this.CallMethod<object>(BLEND_FUNC, sfactor, dfactor);
        public async Task BlendFuncAsync(BlendingMode sfactor, BlendingMode dfactor) => await this.CallMethodAsync(BLEND_FUNC, sfactor, dfactor);
        ...
        public async Task BlendFuncSeparateAsync(BlendingMode srcRGB, BlendingMode dstRGB, BlendingMode srcAlpha, BlendingMode dstAlpha) => await this.CallMethodAsync(BLEND_FUNC_SEPARATE, srcRGB, dstRGB, srcAlpha, dstAlpha);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void ClearDepth(float depth) => this.CallMethod<object>(CLEAR_DEPTH, depth);
        public async Task ClearDepthAsync(float depth) => await this.CallMethodAsync(CLEAR_DEPTH, depth);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void ClearStencil(int stencil) => this.CallMethod<object>(CLEAR_STENCIL, stencil);
        public async Task ClearStencilAsync(int stencil) => await this.CallMethodAsync(CLEAR_STENCIL, stencil);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void ColorMask(bool red, bool green, bool blue, bool alpha) => this.CallMethod<object>(COLOR_MASK, red, green, blue, alpha);
        public async Task ColorMaskAsync(bool red, bool green, bool blue, bool alpha) => await this.CallMethodAsync(COLOR_MASK, red, green, blue, alpha);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void CullFace(Face mode) => this.CallMethod<object>(CULL_FACE, mode);
        public async Task CullFaceAsync(Face mode) => await this.CallMethodAsync(CULL_FACE, mode);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void DepthFunc(CompareFunction func) => this.CallMethod<object>(DEPTH_FUNC, func);
        public async Task DepthFuncAsync(CompareFunction func) => await this.CallMethodAsync(DEPTH_FUNC, func);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void DepthMask(bool flag) => this.CallMethod<object>(DEPTH_MASK, flag);
        public async Task DepthMaskAsync(bool flag) => await this.CallMethodAsync(DEPTH_MASK, flag);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void DepthRange(float zNear, float zFar) => this.CallMethod<object>(DEPTH_RANGE, zNear, zFar);
        public async Task DepthRangeAsync(float zNear, float zFar) => await this.CallMethodAsync(DEPTH_RANGE, zNear, zFar);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void Disable(EnableCap cap) => this.CallMethod<object>(DISABLE, cap);
        public async Task DisableAsync(EnableCap cap) => await this.CallMethodAsync(DISABLE, cap);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void Enable(EnableCap cap) => this.CallMethod<object>(ENABLE, cap);
        public async Task EnableAsync(EnableCap cap) => await this.CallMethodAsync(ENABLE, cap);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void FrontFace(FrontFaceDirection mode) => this.CallMethod<object>(FRONT_FACE, mode);
        public async Task FrontFaceAsync(FrontFaceDirection mode) => await this.CallMethodAsync(FRONT_FACE, mode);
        ...
        public async Task HintAsync(HintTarget target, HintMode mode) => await this.CallMethodAsync(HINT, target, mode);
        ...
        public async Task PolygonOffsetAsync(float factor, float units) => await this.CallMethodAsync(POLYGON_OFFSET, factor, units);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void SampleCoverage(float value, bool invert) => this.CallMethod<object>(SAMPLE_COVERAGE, value, invert);
        public async Task SampleCoverageAsync(float value, bool invert) => await this.CallMethodAsync(SAMPLE_COVERAGE, value, invert);
        ...
        public async Task StencilFuncAsync(CompareFunction func, int reference, uint mask) => await this.CallMethodAsync(STENCIL_FUNC, func, reference, mask);
        ...
        public async Task StencilFuncSeparateAsync(Face face, CompareFunction func, int reference, uint mask) => await this.CallMethodAsync(STENCIL_FUNC_SEPARATE, face, func, reference, mask);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void StencilMask(uint mask) => this.CallMethod<object>(STENCIL_MASK, mask);
        public async Task StencilMaskAsync(uint mask) => await this.CallMethodAsync(STENCIL_MASK, mask);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void StencilMaskSeparate(Face face, uint mask) => this.CallMethod<object>(STENCIL_MASK_SEPARATE, face, mask);
        public async Task StencilMaskSeparateAsync(Face face, uint mask) => await this.CallMethodAsync(STENCIL_MASK_SEPARATE, face, mask);
        ...
        public async Task StencilOpAsync(StencilFunction fail, StencilFunction zfail, StencilFunction zpass) => await this.CallMethodAsync(STENCIL_OP, fail, zfail, zpass);
        ...
        public async Task StencilOpSeparateAsync(Face face, StencilFunction fail, StencilFunction zfail, StencilFunction zpass) => await this.CallMethodAsync(STENCIL_OP_SEPARATE, face, fail, zfail, zpass);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void BindBuffer(BufferType target, WebGLBuffer buffer) => this.CallMethod<object>(BIND_BUFFER, target, buffer);
        public async Task BindBufferAsync(BufferType target, WebGLBuffer buffer) => await this.CallMethodAsync(BIND_BUFFER, target, buffer);
        ...
        public async Task BufferDataAsync(BufferType target, int size, BufferUsageHint usage) => await this.CallMethodAsync(BUFFER_DATA, target, size, usage);
        ...
        public async Task BufferDataAsync<T>(BufferType target, T[] data, BufferUsageHint usage) => await this.CallMethodAsync(BUFFER_DATA, target, this.ConvertToByteArray(data), usage);
        ...
        public async Task BufferSubDataAsync<T>(BufferType target, uint offset, T[] data) => await this.CallMethodAsync(BUFFER_SUB_DATA, target, offset, this.ConvertToByteArray(data));
        ...
        public async Task DeleteBufferAsync(WebGLBuffer buffer) => await this.CallMethodAsync(DELETE_BUFFER, buffer);
        ...
        public async Task BindFramebufferAsync(FramebufferType target, WebGLFramebuffer framebuffer) => await this.CallMethodAsync(BIND_FRAMEBUFFER, target, framebuffer);
        ...
        public async Task DeleteFramebufferAsync(WebGLFramebuffer buffer) => await this.CallMethodAsync(DELETE_FRAMEBUFFER, buffer);
        ...
        public async Task FramebufferRenderbufferAsync(FramebufferType target, FramebufferAttachment attachment, RenderbufferType renderbuffertarget, WebGLRenderbuffer renderbuffer) => await this.CallMethodAsync(FRAMEBUFFER_RENDERBUFFER, target, attachment, renderbuffertarget, renderbuffer);
        ...
        public async Task FramebufferTexture2DAsync(FramebufferType target, FramebufferAttachment attachment, Texture2DType textarget, WebGLTexture texture, int level) => await this.CallMethodAsync(FRAMEBUFFER_TEXTURE_2D, target, attachment, textarget, texture, level);
        ...
        public async Task ReadPixelsAsync(int x, int y, int width, int height, PixelFormat format, PixelType type, byte[] pixels) => await this.CallMethodAsync(READ_PIXELS, x, y, width, height, format, type, pixels); //pixels should be an ArrayBufferView which the data gets read into
        ...
        public async Task BindRenderbufferAsync(RenderbufferType target, WebGLRenderbuffer renderbuffer) => await this.CallMethodAsync(BIND_RENDERBUFFER, target, renderbuffer);
        ...
        public async Task DeleteRenderbufferAsync(WebGLRenderbuffer buffer) => await this.CallMethodAsync(DELETE_RENDERBUFFER, buffer);
        ...
        public async Task RenderbufferStorageAsync(RenderbufferType type, RenderbufferFormat internalFormat, int width, int height) => await this.CallMethodAsync(RENDERBUFFER_STORAGE, type, internalFormat, width, height);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void BindTexture(TextureType type, WebGLTexture texture) => this.CallMethod<object>(BIND_TEXTURE, type, texture);
        public async Task BindTextureAsync(TextureType type, WebGLTexture texture) => await this.CallMethodAsync(BIND_TEXTURE, type, texture);
        ...
        public async Task CopyTexImage2DAsync(Texture2DType target, int level, PixelFormat format, int x, int y, int width, int height, int border) => await this.CallMethodAsync(COPY_TEX_IMAGE_2D, target, level, format, x, y, width, height, border);
        ...
        public async Task CopyTexSubImage2DAsync(Texture2DType target, int level, int xoffset, int yoffset, int x, int y, int width, int height) => await this.CallMethodAsync(COPY_TEX_SUB_IMAGE_2D, target, level, xoffset, yoffset, x, y, width, height);
        ...
        public async Task DeleteTextureAsync(WebGLTexture texture) => await this.CallMethodAsync(DELETE_TEXTURE, texture);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void GenerateMipmap(TextureType target) => this.CallMethod<object>(GENERATE_MIPMAP, target);
        public async Task GenerateMipmapAsync(TextureType target) => await this.CallMethodAsync(GENERATE_MIPMAP, target);
        ...
        public async Task TexImage2DAsync<T>(Texture2DType target, int level, PixelFormat internalFormat, int width, int height, PixelFormat format, PixelType type, T[] pixels)
            where T : struct
            => await this.CallMethodAsync(TEX_IMAGE_2D, target, level, internalFormat, width, height, format, type, pixels);
        ...
        public async Task TexSubImage2DAsync<T>(Texture2DType target, int level, int xoffset, int yoffset, int width, int height, PixelFormat format, PixelType type, T[] pixels)
            where T : struct
            => await this.CallMethodAsync(TEX_SUB_IMAGE_2D, target, level, xoffset, yoffset, width, height, format, type, pixels);
        ...
        public async Task TexParameterAsync(TextureType target, TextureParameter pname, float param) => await this.CallMethodAsync(TEX_PARAMETER_F, target, pname, param);
        ...
        public async Task TexParameterAsync(TextureType target, TextureParameter pname, int param) => await this.CallMethodAsync(TEX_PARAMETER_I, target, pname, param);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void AttachShader(WebGLProgram program, WebGLShader shader) => this.CallMethod<object>(ATTACH_SHADER, program, shader);
        public async Task AttachShaderAsync(WebGLProgram program, WebGLShader shader) => await this.CallMethodAsync(ATTACH_SHADER, program, shader);
        ...
        public async Task BindAttribLocationAsync(WebGLProgram program, uint index, string name) => await this.CallMethodAsync(BIND_ATTRIB_LOCATION, program, index, name);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void CompileShader(WebGLShader shader) => this.CallMethod<object>(COMPILE_SHADER, shader);
        public async Task CompileShaderAsync(WebGLShader shader) => await this.CallMethodAsync(COMPILE_SHADER, shader);
        ...
        public async Task DeleteProgramAsync(WebGLProgram program) => await this.CallMethodAsync(DELETE_PROGRAM, program);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void DeleteShader(WebGLShader shader) => this.CallMethod<object>(DELETE_SHADER, shader);
        public async Task DeleteShaderAsync(WebGLShader shader) => await this.CallMethodAsync(DELETE_SHADER, shader);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void DetachShader(WebGLProgram program, WebGLShader shader) => this.CallMethod<object>(DETACH_SHADER, program, shader);
        public async Task DetachShaderAsync(WebGLProgram program, WebGLShader shader) => await this.CallMethodAsync(DETACH_SHADER, program, shader);
        ...
        public async Task LinkProgramAsync(WebGLProgram program) => await this.CallMethodAsync(LINK_PROGRAM, program);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void ShaderSource(WebGLShader shader, string source) => this.CallMethod<object>(SHADER_SOURCE, shader, source);
        public async Task ShaderSourceAsync(WebGLShader shader, string source) => await this.CallMethodAsync(SHADER_SOURCE, shader, source);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void UseProgram(WebGLProgram program) => this.CallMethod<object>(USE_PROGRAM, program);
        public async Task UseProgramAsync(WebGLProgram program) => await this.CallMethodAsync(USE_PROGRAM, program);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void ValidateProgram(WebGLProgram program) => this.CallMethod<object>(VALIDATE_PROGRAM, program);
        public async Task ValidateProgramAsync(WebGLProgram program) => await this.CallMethodAsync(VALIDATE_PROGRAM, program);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void DisableVertexAttribArray(uint index) => this.CallMethod<object>(DISABLE_VERTEX_ATTRIB_ARRAY, index);
        public async Task DisableVertexAttribArrayAsync(uint index) => await this.CallMethodAsync(DISABLE_VERTEX_ATTRIB_ARRAY, index);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void EnableVertexAttribArray(uint index) => this.CallMethod<object>(ENABLE_VERTEX_ATTRIB_ARRAY, index);
        public async Task EnableVertexAttribArrayAsync(uint index) => await this.CallMethodAsync(ENABLE_VERTEX_ATTRIB_ARRAY, index);
        ...
        public async Task VertexAttribPointerAsync(uint index, int size, DataType type, bool normalized, int stride, long offset) => await this.CallMethodAsync(VERTEX_ATTRIB_POINTER, index, size, type, normalized, stride, offset);
        ...
        public async Task UniformAsync(WebGLUniformLocation location, params float[] value)
        {
            ...
            {
                case 1:
                    await this.CallMethodAsync(UNIFORM + "1fv", location, value);
                    break;
                case 2:
                    await this.CallMethodAsync(UNIFORM + "2fv", location, value);
                    break;
                case 3:
                    await this.CallMethodAsync(UNIFORM + "3fv", location, value);
                    break;
                case 4:
                    await this.CallMethodAsync(UNIFORM + "4fv", location, value);
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(value), value.Length, "Value array is empty or too long");
            }
        ...
        public async Task UniformAsync(WebGLUniformLocation location, params int[] value)
        {
            ...
            {
                case 1:
                    await this.CallMethodAsync(UNIFORM + "1iv", location, value);
                    break;
                case 2:
                    await this.CallMethodAsync(UNIFORM + "2iv", location, value);
                    break;
                case 3:
                    await this.CallMethodAsync(UNIFORM + "3iv", location, value);
                    break;
                case 4:
                    await this.CallMethodAsync(UNIFORM + "4iv", location, value);
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(value), value.Length, "Value array is empty or too long");
            }
        ...
        public async Task UniformMatrixAsync(WebGLUniformLocation location, bool transpose, float[] value)
        {
            ...
            {
                case 2 * 2:
                    await this.CallMethodAsync(UNIFORM_MATRIX + "2fv", location, transpose, value);
                    break;
                case 3 * 3:
                    await this.CallMethodAsync(UNIFORM_MATRIX + "3fv", location, transpose, value);
                    break;
                case 4 * 4:
                    await this.CallMethodAsync(UNIFORM_MATRIX + "4fv", location, transpose, value);
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(value), value.Length, "Value array has incorrect size");
            }
        ...
        public async Task VertexAttribAsync(uint index, params float[] value)
        {
            ...
            {
                case 1:
                    await this.CallMethodAsync(VERTEX_ATTRIB + "1fv", index, value);
                    break;
                case 2:
                    await this.CallMethodAsync(VERTEX_ATTRIB + "2fv", index, value);
                    break;
                case 3:
                    await this.CallMethodAsync(VERTEX_ATTRIB + "3fv", index, value);
                    break;
                case 4:
                    await this.CallMethodAsync(VERTEX_ATTRIB + "4fv", index, value);
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(value), value.Length, "Value array is empty or too long");
            }
        ...
        public async Task DrawArraysAsync(Primitive mode, int first, int count) => await this.CallMethodAsync(DRAW_ARRAYS, mode, first, count);
        ...
        public async Task DrawElementsAsync(Primitive mode, int count, DataType type, long offset) => await this.CallMethodAsync(DRAW_ELEMENTS, mode, count, type, offset);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void Finish() => this.CallMethod<object>(FINISH);
        public async Task FinishAsync() => await this.CallMethodAsync(FINISH);

        [Obsolete("Use the async version instead, which is already called internally.")]
        public void Flush() => this.CallMethod<object>(FLUSH);
        public async Task FlushAsync() => await this.CallMethodAsync(FLUSH);
